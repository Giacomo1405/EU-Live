...
NDiplomacy = {
	...
	IMPERIAL_REFORM_COST = 60,						-- Minium Cost of enacting a new reform.
	...
	WE_IMPACT_ON_ANNEX_INTEGRATE = -0.15,			-- multiplied with current WE
	EMPEROR_VOTE_DAYS = 60,	 						-- _DDEF_EMPEROR_VOTE_DAYS_; "Cooldown" until Electors can change their vote again.
	TRUCE_YEARS = 4, 								-- _DDEF_TRUCE_YEARS_; Years of Truce
	...
	PO_ANNEX_BADBOY = 25, 							-- _DDEF_PO_ANNEX_BADBOY = 10, (No effect on loser :)
	...
	PO_BECOME_VASSAL_BADBOY = 20, 					-- _DDEF_PO_BECOME_VASSAL_BADBOY = 10,
...
NCountry = {
	...
	WESTERN_NEEDED_MAX_POWER = 6500,					-- needed for full westernisation
	...
	TECH_TIME_COST = 0.22,			-- tech grow with 20% cost over time.
	...
	CORE_LOSE = 60, 								-- how many years until a core is lost.
	CORE_LOSE_CULTURE_GROUP = 225,					-- how many years until a core in a country's culture group is lost.
...
NEconomy = {
	LAND_TECH_MAINTENANCE_IMPACT = 0.15, 			-- % each tech increases it.
...
NMilitary = {
	...
	HEAVY_SHIP_MANPOWER_COST = 0.3,					-- 1 = 1000 men in cost.
	LIGHT_SHIP_MANPOWER_COST = 0.15,					-- 1 = 1000 men in cost.
	GALLEY_SHIP_MANPOWER_COST = 0.15,				-- 1 = 1000 men in cost.
	TRANSPORT_SHIP_MANPOWER_COST = 0.05,				-- 1 = 1000 men in cost.
...
NAI = {
	...
	PEACE_ALLY_WARGOAL_MULT = 1.0, -- Multiplies PEACE_WARGOAL_FACTOR for allies in a war
